...
(function(){
  angular.module('hz')
    ...
    ['merlin.field.models', 'merlin.panel.models', function(fields, panel) {
      ...
      models.wildcard = Barricade.Blueprint.create(function() { return this; });
      models.wildcard.Factory = function(json, parameters) {
        var type = Barricade.getType(json), value;
        if ( json === undefined || type === String ) {
          value = fields.string.create(json, parameters);
          return models.wildcard.call(value);
        } else if ( type === Array ) {
          ...
          '@class': fields.frozendict.extend({
            create: function(json, parameters) {
              ...
              self.on('childChange', function(child) {
                if ( child.instanceof(Barricade.Enumerated) ) {
                  var value = self.get('value');
                  switch ( child.get() ) {
                    case 'string':
                      self.set('value', models.wildcard.Factory(''));
                      break;
                    case 'list':
                      self.set('value', models.wildcard.Factory(['']));
                      break;
                    case 'dictionary':
                      self.set('value', models.wildcard.Factory({'key1': ''}));
                      break;
                  }
                }
              });
            ...
            'value': {
              '@class': models.wildcard,
              '@factory': models.wildcard.Factory
            }
          })
        }
      });
