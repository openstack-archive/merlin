    ...
    ['merlin.field.models', 'merlin.panel.models', 'merlin.utils', '$http', '$q',
      function(fields, panel, utils, $http, $q) {
        ...
        models.WorkflowTaskMixin = Barricade.Blueprint.create(function() {
          return this.extend({
            resolveWith: function(parent) {
              this.get('workflow').resolveWith(parent);
            }
          }, {
            'workflow': {
              '@class': fields.string.extend({
                create: function(json, parameters) {
                  ...
                  self._workflows.on('replaceComplete', function() {
                    if ( !self._workflows.isPlaceholder() ) {
                ...
                resolveWith: function(parent) {
                  return this._workflows.resolveWith(parent);
                },
                _choices: null
              }, {
                '@enum': function() {
